...
Plasma::Plasma(int damage, int velocity, std::pair<int, int> initial_position) :
...
Bomb::Bomb(int damage, int velocity, std::pair<int, int> initial_position) :
        Projectile(damage, velocity, initial_position) {}
...
Magnet::Magnet(int damage, int velocity, std::pair<int, int> initial_position) :
        Projectile(damage, velocity, initial_position) {}
...
Spark::Spark(int damage, int velocity, std::pair<int, int> initial_position) :
        Projectile(damage, velocity, initial_position) {}
...
Fire::Fire(int damage, int velocity, std::pair<int, int> initial_position) :
        Projectile(damage, velocity, initial_position) {}
...
Ring::Ring(int damage, int velocity, std::pair<int, int> initial_position) :
        Projectile(damage, velocity, initial_position) {}
...
void Cannon::change_current_ammo(int ammo_id) {
    this->current_ammo = this->ammos[ammo_id];
}

Projectile* Cannon::shoot() {
    return this->current_ammo->use();
}
